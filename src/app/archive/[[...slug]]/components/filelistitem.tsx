...
export const FileListItem = ({file, key_string, delay, current=false, year=false, isRecent=false}:
{
  file: {url:string, title: string, date:string},
  key_string:string, delay:number, current?:boolean, year?:boolean, isRecent?:boolean
}) => {
  return fileListItem(file, key_string, delay, current, year, isRecent)
}

export const fileListItem = (file: {url:string, title: string, date:string}, key:string, delay:number, current?:boolean, year?:boolean, isRecent?:boolean) => {
  return (
